...
class Members_Signup {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Members_Signup_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Members_Signup_Loader. Orchestrates the hooks of the plugin.
	 * - Members_Signup_i18n. Defines internationalization functionality.
	 * - Members_Signup_Admin. Defines all hooks for the admin area.
	 * - Members_Signup_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Members_Signup_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Members_Signup_Loader    Orchestrates the hooks of the plugin.
	 */
