 ...
 * @subpackage Members_Signup/public
 */
...
class Members_Signup_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Members_Signup_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Members_Signup_Loader will then create the relationship
